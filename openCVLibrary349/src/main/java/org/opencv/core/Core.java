...
public class Core {
    ...
    private static String getVersion() { return "3.4.9"; }
    private static String getNativeLibraryName() { return "opencv_java349"; }
    private static int getVersionMajorJ() { return 3; }
    private static int getVersionMinorJ() { return 4; }
    private static int getVersionRevisionJ() { return 9; }
